...
def get_bake_obj(context: bpy.types.Context, objs_to_bake: list, bake_name: str):
    """ """
...
def clear_bake_obj(context: bpy.types.Context, obj: bpy.types.Object):
    """ """
    settings = context.scene.SDFBakerSettings
...
def build_geonodes_sdf_linearindextounitindex_node_group():
...
def build_geonodes_sdf_getvoxeldata_node_group():
    # https://github.com/BrendanParmer/NodeToPython/
...
def build_geonodes_sdf_indextounit2dposition_node_group():
    # https://github.com/BrendanParmer/NodeToPython/
...
def build_geonodes_sdf_3d_node_group():
    # https://github.com/BrendanParmer/NodeToPython/
...
def get_best_texture_resolution(context: bpy.types.Context):
